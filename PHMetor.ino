...
#include "ph_grav.h"                                  //header file for Atlas Scientific gravity pH sensor
                         //header file for liquid crystal display (lcd)
...
Gravity_pH pH = A1;                                   //assign analog pin A0 of Arduino to class Gravity_pH. connect output of pH sensor to pin A0
             //make a variable pH_lcd and assign arduino digital pins to lcd pins (2 -> RS, 3 -> E, 4 to 7 -> D4 to D7)
...
void parse_cmd(char* string) {                      //For calling calibration functions
  string=strupr(string);                                   //convert input string to uppercase
Serial.println("hgjhfjyftdrgsfsfdgnh");
